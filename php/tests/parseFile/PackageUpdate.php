...
class PEAR_PackageUpdate
{
    ...
    function &factory($driver, $packageName, $channel)
    {
        ...
        // Attempt to require a custom version of the named class, but don't treat
        // a failure as fatal.  The caller may have already included their own
        // version of the named class.
        if (!class_exists($class)) {

            // Try to require the driver.
    ...
    /**
     * Returns whether or not a path is in the require path.
     *
     * @static
     * @access public
     * @param  string  $path
     * @return boolean true if the path is in the require path.
     * @since  0.4.2
     */
    function isIncludable($path)
    {
        // Break up the require path and check to see if the path is readable.
        ...
        // If we got down here, the path is not readable from the require path.
        return false;
    }
