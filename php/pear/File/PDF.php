...
class File_PDF {
     ...
     *
     * Wraps around PEAR::raiseError() to avoid having to require PEAR.php
    ...
    function addFont($family, $style = '', $file = '')
    {
        ...
        include($file);
        if (!isset($name)) {
            return $this->raiseError('Could not require font definition file');
        }
    ...
    function _getFontFile($fontkey, $path = '')
    {
        ...
        if (!isset($font_widths[$fontkey])) {
            ...
            include $file;
            if (!isset($font_widths[$fontkey])) {
                return $this->raiseError(sprintf('Could not require font metric file: %s', $file));
            }
        }
