...
#!perl
#line 29
    eval 'exec C:\Users\rcond\Google Drive\NOV8\Attendance System\xampp\perl\bin\perl.exe -S $0 ${1+"$@"}'
...
my $perlpath = 'C:\Users\rcond\Google Drive\NOV8\Attendance System\xampp\perl\bin\perl.exe';
