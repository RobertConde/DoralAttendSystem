...
class Node
{
     ...
     *
     * @param bool $self       Whether to require the Node itself in the results
     * @param bool $containers Whether to require nodes of type CONTAINER
     * @param bool $groups     Whether to require nodes which have $group == true
     *
