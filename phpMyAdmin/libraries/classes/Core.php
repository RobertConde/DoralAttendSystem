...
class Core
{
    ...
    /**
     * Removes insecure parts in a path; used before require() or
    ...
    public static function headerJSON(): void
    {
        ...
        // This is needed in case we require HTML in JSON, browser might assume it's
        // html to display
     ...
     *
     * @param string $filename Filename to require in headers if empty,
     *                         none Content-Disposition header will be sent.
     * @param string $mimetype MIME type to require in headers.
     * @param int    $length   Length of content (optional)
     * @param bool   $no_cache Whether to require no-caching headers.
     *
     * @return void
     */
