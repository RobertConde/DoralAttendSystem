...
class ExportSql extends ExportPlugin
{
    ...
    protected function setProperties()
    {
        ...
        if (! $hide_sql) {
            ...
            $leaf->setValues(
                [
                    'complete' => __(
                        'require column names in every <code>INSERT</code> statement'
     ...
     *                                          of error
     * @param bool   $show_dates                whether to require creation/
     *                                          update/check dates
     ...
     * @param bool   $do_relation whether to require relation comments
     * @param bool   $do_mime     whether to require mime comments
     * @param array  $aliases     Aliases of db/table/columns
     *
     ...
     *                            'stand_in'
     * @param string $export_type 'server', 'database', 'table'
     * @param bool   $relation    whether to require relation comments
     * @param bool   $comments    whether to require the pmadb-style column
     *                            comments as comments in the structure; this is
     *                            deprecated but the parameter is left here
     *                            because export.php calls exportStructure()
     *                            also for other export types which use this
     *                            parameter
     * @param bool   $mime        whether to require mime comments
     * @param bool   $dates       whether to require creation/update/check dates
     * @param array  $aliases     Aliases of db/table/columns
     *
     * @return bool Whether it succeeded
     */
